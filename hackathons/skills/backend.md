...
Backend patterns optimized for speed, clarity, and demo-ability. Not enterprise architecture  just enough structure to ship something clean in 2448 hours.
...
- **23 tables max.** Users + main entity + maybe one join table.
...
When scaffolding a hackathon project, strictly adhere to a Feature-First Architecture. This prevents AI context fragmentation and ensures modularity.
...
app/
  ...
  features/          (Modular Logic)
    [feature-name]/
      router.py      (API endpoints)
      service.py     (Business logic)
      schemas.py     (Pydantic models)
      models.py      (SQLAlchemy/Tortoise)
  lib/               (Database init, external clients)
requirements.txt
Dockerfile
```
