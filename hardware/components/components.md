...
| **OLED display (SSD1306 128×64)** | Like the MAX7219 matrix but pixel-precise and I2C-driven; higher-resolution grayscale version of the matrix | Oscilloscope UI, cleaner data readouts |
